...
const Complaints = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (cookies) {
                ...
                try {
                    const response = await axios.get('http://192.168.1.8:3000/fm/allcomplaints', {
                        headers,
                    });
    ...
    const updateStatus = async () => {
        if (selectedComplaint) {
            ...
            try {
                const response = await axios.put(`http://192.168.1.8:3000/fm/updatecomplaint/${selectedComplaint.ComplaintCode}`, { status });
