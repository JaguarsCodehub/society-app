...
const RequestService = () => {
    ...
    useEffect(() => {
        const fetchAsyncStorageData = async () => {
            try {
                const keys = ['MemberSocietyID', 'MemberID', 'UserID', 'MemberYear', 'MemberName', 'MemberWing', 'MemberFlat', 'MemberCode', 'MemberMobileNumber'];
    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                <View>
                    <Text style={{ fontSize: 30, fontWeight: "600" }}>What Service are you Requesting ?</Text>
                    <Text style={{ fontSize: 15, fontWeight: "500", color: "gray" }}>Add some details regarding your Service Request and we will make sure we try to fulfil it</Text>
                </View>
                ...
                <View style={styles.cameraContainer}>
                    <Text style={{ fontSize: 20, fontWeight: "600" }}>Want to show by clicking a Photo ?</Text>
                    <TouchableOpacity onPress={pickImage} style={{ backgroundColor: "green", alignItems: "center", justifyContent: "center", marginTop: 10, padding: 10, borderRadius: 5 }}>
