...
export default function ComplaintRegister() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showToastWithGravityAndOffset('Your Complaint was submitted !');
      setSubject('');
      setDescription('');
      setStatus('');
      setImage(null);
    } catch (error) {
      showToastWithGravityAndOffset('Error occurred while submitting error');
      ...
      <View style={styles.container}>
        ...
        <View style={styles.cameraContainer}>
          <Text style={{ fontSize: 15, fontWeight: '600' }}>
            Upload Photo Regarding a Complaint
          </Text>
          <TouchableOpacity
            onPress={pickImage}
